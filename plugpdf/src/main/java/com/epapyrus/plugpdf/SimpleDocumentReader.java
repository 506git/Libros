...
public class SimpleDocumentReader implements ReaderListener {
	 ...
	 *
	 * @param state The state value is the result of the PDF document load.
	 */
	...
	public void onSingleTapUp(MotionEvent e) {
		...
		BaseField[] allField = mReaderView.getAllField(mReaderView.getPageIdx());
		if(allField != null) {
			for (BaseField textField : allField) {
	...
	/**
	 * Set tha number of preview image.
	 * If you set count, you can see (2 * count + 1) page's preview image.
	 * @param count (range: 0 ~ 4)
	 *
	 */
	public void setNumberOfPreView(int count)
	{
		mControlView.setNumberOfPreView(count);
	}
